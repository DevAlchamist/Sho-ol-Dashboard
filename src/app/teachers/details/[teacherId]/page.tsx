  ...
  return (
    <Box className="h-screen overflow-y-auto">
      ...
      <Box className="grid xl:grid-cols-12  lg:grid-cols-12 grid-cols-1">
        <Box className=" py-10 pr-5 pl-5 col-span-9">
        ...
        <Box className="flex gap-y-5 py-[60px] justify-start items-center flex-col col-span-3">
          ...
          <Box className="overflow-y-auto no-scrollbar h-[680px]">
            <Box className="bg-[#4D44B5] w-[386px] mb-5 rounded-3xl h-[186px] flex flex-col justify-center items-end text-start">
            ...
            <Box className="bg-[#FB7D5B] w-[386px] my-5 rounded-3xl h-[186px] flex flex-col justify-center items-end text-start">
              <Box className="w-[362px] h-[186px] bg-white flex flex-col justify-around items-start text-start">
                <Box className="ml-2 text-xl text-[#303972] font-bold">
                  Ancient History
                  <Typography className="font-extralight">
            ...
            <Box className="bg-[#FCC43E] w-[386px] my-5 rounded-3xl h-[186px] flex flex-col justify-center items-end text-start">
              <Box className="w-[362px] h-[186px] bg-white flex flex-col justify-around items-start text-start">
                <Box className="ml-2 text-xl text-[#303972] font-bold">
                  Ancient History
                  <Typography className="font-extralight">
            ...
            <Box className="bg-[#303972] w-[386px] mt-5 rounded-3xl h-[186px] flex flex-col justify-center items-end text-start">
              <Box className="w-[362px] h-[186px] bg-white flex flex-col justify-around items-start text-start">
                <Box className="ml-2 text-xl text-[#303972] font-bold">
                  Ancient History
                  <Typography className="font-extralight">
            ...
            <Button className="font-semibold py-3 w-full rounded-full bg-[#4D44B5]/10 text-[#4D44B5]">View More</Button>
        </Box>
      </Box>
    </Box>
  );
